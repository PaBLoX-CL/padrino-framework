...
describe "ProjectGenerator" do
  ...
  context "the generator for test component" do
    ...
    should "properly generate for cucumber" do
      ...
      assert_match_in_file(/gem 'webrat'/, "#{@apptmp}/sample_project/Gemfile")
      assert_match_in_file(/RACK_ENV = 'test' unless defined\?\(RACK_ENV\)/, "#{@apptmp}/sample_project/spec/spec_helper.rb")
      assert_match_in_file(/RACK_ENV = 'test' unless defined\?\(RACK_ENV\)/, "#{@apptmp}/sample_project/features/support/env.rb")
      assert_match_in_file(/World\(Webrat::Methods\)/, "#{@apptmp}/sample_project/features/support/env.rb")
      assert_match_in_file(/World\(Webrat::Matchers\)/, "#{@apptmp}/sample_project/features/support/env.rb")
